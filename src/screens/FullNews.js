...
export default function FullNews({navigation, pageTitle}) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.news}>
        <Image
          style={{width: 370, height: 200, borderRadius: 30}}
          source={require('../../images/coinbase.jpg')}
        />
      </View>
      <Text numberOfLines={2} style={styles.newstext}>
        Coinbase crypto based payment platform gateway is a game changer for the
        fintech industry
      </Text>
