        ...
        <Modalize ref={modalizeRef} snapPoint={800}>
                <View
                  ...
                  <View style={styles.modalbottons}>
                    <Text style={styles.modalCaption}>Who Traded</Text>
                    <Text style={styles.desc9}>
                      Friends who made a cash deposit, traded up tp 10 BUSD and their commission payout date. Pennyswap rewards have been limited to your first 10 successful referrals, every month
                    </Text>
                  </View>
                  <View style={styles.noOfFriends}>
                    <Text style={styles.noOfFriends1}>Friends </Text>
