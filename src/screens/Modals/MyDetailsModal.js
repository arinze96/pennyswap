...
function MyDetailsModal() {
  return (
      ...
      <View style={styles.modalbottons0}>
        ...
        <TouchableOpacity>
          <View style={styles.actionIcon1}>
            <Text style={{color: colors.major}}>Done</Text>
          </View>
        </TouchableOpacity>
      </View>
      <View style={styles.modalbottons}>
        <Text style={styles.modalCaption}>My Details</Text>
        <Text style={styles.desc9}>
           Type in your preferred name and your pennyswap username
        </Text>
      </View>
    </View>
    <Text style={styles.desc19}>Your preferred name</Text>
    <View style={styles.modalCaption0}>
      <View style={styles.textInput2}>
        <TextInput style={styles.textInput4} placeholder="Stephlon Don" />
      </View>
    </View>
   
    <Text style={styles.desc19}>Your Pennyswap Username</Text>
    <View style={styles.modalCaption0}>
      <View style={styles.textInput2}>
        <TextInput style={styles.textInput4} placeholder="@jeremy24" />
      </View>
    </View>
    <Text style={styles.desc19}>
      Choose a unique name you can share with friends so that you can receive payments from them
    </Text>
    <Text style={styles.desc19}>Email</Text>
    <View style={styles.modalCaption0}>
      <View style={styles.textInput2}>
        <TextInput style={styles.textInput4} placeholder="steoh@gmail.com" />
      </View>
    </View>
    ...
    <View style={styles.modalCaption0}>
      <View style={styles.textInput2}>
        <TextInput style={styles.textInput4} placeholder="+14680293882" />
      </View>
    </View>
