  ...
  return (
    ...
    <View
      ...
      <View style={styles.modalbottons}>
        <Text style={styles.modalCaption}>Transaction Pin</Text>
        <Text style={styles.modalCaption0}>create transaction pin</Text>
      </View>
      <TouchableOpacity
        ...
        <Text style={styles.upperText1}>Create Pin </Text>
          <Text style={styles.upperText2}>create a new pin </Text>
        </View>
        <FontAwesome5
          name={'chevron-right'}
          size={15}
